...
const Evaluated_product = () => {
  ...
  const [Company__ExistingProducts, setCompany__ExistingProducts] = useState("")
  const [Email__ExistingProducts, setEmail__ExistingProducts] = useState("")
  const [Phone_Number__ExistingProducts, setPhone_Number__ExistingProducts] = useState("")
  const [Address__ExistingProducts, setAddress__ExistingProducts] = useState("")
  const [City__ExistingProducts, setCity__ExistingProducts] = useState("")
  const [Zip__ExistingProducts, setZip__ExistingProducts] = useState("")
  const [Address_2__ExistingProducts, setAddress_2__ExistingProducts] = useState("")
  const [State__ExistingProducts, setState__ExistingProducts] = useState("")
  const [United_States__ExistingProducts, setUnited_States__ExistingProducts] = useState("")
  ////
  const [Description__ExistingProducts, setDescription__ExistingProducts] = useState("")
  const [EMC__Existing_Products, setEMC__Existing_Products] = useState(false)
  const [EMC__Existing_Products1, setEMC__Existing_Products1] = useState("")
  const [SAFETY__Existing_Products, setSAFETY__Existing_Products] = useState(false)
  const [SAFETY__Existing_Products1, setSAFETY__Existing_Products1] = useState("")
  const [LASER_SAFETY__Existing_Products, setLASER_SAFETY__Existing_Products] = useState(false)
  const [LASER_SAFETY__Existing_Products1, setLASER_SAFETY__Existing_Products1] = useState("")
  const [MEDICAL_SAFETY__Existing_Products, setMEDICAL_SAFETY__Existing_Products] = useState(false)
  const [MEDICAL_SAFETY__Existing_Products1, setMEDICAL_SAFETY__Existing_Products1] = useState("")
  const [IP_TESTING__Existing_Products, setIP_TESTING__Existing_Products] = useState(false)
  const [IP_TESTING__Existing_Products1, setIP_TESTING__Existing_Products1] = useState("")
  const [EMC_3m_CHAMBER_TIME__Existing_Products, setEMC_3m_CHAMBER_TIME__Existing_Products] = useState(false)
  const [EMC_3m_CHAMBER_TIME__Existing_Products1, setEMC_3m_CHAMBER_TIME__Existing_Products1] = useState("")
  const [EMC_10m_CHAMBER_TIME__Existing_Products, setEMC_10m_CHAMBER_TIME__Existing_Products] = useState(false)
  const [EMC_10m_CHAMBER_TIME__Existing_Products1, setEMC_10m_CHAMBER_TIME__Existing_Products1] = useState("")
  const [ENVIRONMENTAL_CHAMBER_TIME__Existing_Products, setENVIRONMENTAL_CHAMBER_TIME__Existing_Products] = useState(false)
  const [ENVIRONMENTAL_CHAMBER_TIME__Existing_Products1, setENVIRONMENTAL_CHAMBER_TIME__Existing_Products1] = useState("")
  const [Pleaseselectintendedmarketcountries, setPleaseselectintendedmarketcountries] = useState("")
  const [RFQCategory, setRFQCategory] = useState('Existing Certified')
...
const handleAddFields1 = () => {
  setInputFields1([...inputFields1, { id: uuidv4(), firstName: '', lastName: '' }])
}
...
const handleAddFields2 = () => {
  setInputFields2([...inputFields2, { id: uuidv4(), firstName: '', lastName: '' }])
}
...
const handleChangeInput2 = (id, event) => {
  ...
  const data = {
    ...
    //
    Description__ExistingProducts: Description__ExistingProducts,
    EMC__Existing_Products: EMC__Existing_Products,
    EMC__Existing_Products1: EMC__Existing_Products1,
    SAFETY__Existing_Products: SAFETY__Existing_Products,
    SAFETY__Existing_Products1: SAFETY__Existing_Products1,
    LASER_SAFETY__Existing_Products: LASER_SAFETY__Existing_Products,
    LASER_SAFETY__Existing_Products1: LASER_SAFETY__Existing_Products1,
    MEDICAL_SAFETY__Existing_Products: MEDICAL_SAFETY__Existing_Products,
    MEDICAL_SAFETY__Existing_Products1: MEDICAL_SAFETY__Existing_Products1,
    IP_TESTING__Existing_Products: IP_TESTING__Existing_Products,
    IP_TESTING__Existing_Products1: IP_TESTING__Existing_Products1,
    EMC_3m_CHAMBER_TIME__Existing_Products: EMC_3m_CHAMBER_TIME__Existing_Products,
    EMC_3m_CHAMBER_TIME__Existing_Products1: EMC_3m_CHAMBER_TIME__Existing_Products1,
    EMC_10m_CHAMBER_TIME__Existing_Products: EMC_10m_CHAMBER_TIME__Existing_Products,
    EMC_10m_CHAMBER_TIME__Existing_Products1: EMC_10m_CHAMBER_TIME__Existing_Products1,
    ENVIRONMENTAL_CHAMBER_TIME__Existing_Products: ENVIRONMENTAL_CHAMBER_TIME__Existing_Products,
    ENVIRONMENTAL_CHAMBER_TIME__Existing_Products1: ENVIRONMENTAL_CHAMBER_TIME__Existing_Products1,
    Pleaseselectintendedmarketcountries: Pleaseselectintendedmarketcountries,
      ...
      <div>
        ...
        <Container maxWidth="sm" >
          <Typography variant="h4" gutterBottom className={classes.MainHeading2}>
            Existing Certified/Evaluated product
          </Typography>
        </Container>
        <Container maxWidth="md">
          <Typography
            ...
            Select this option to get a quote for performing pre-compliance testing to ensure that your prototype meets <span className={classes.span}> intended market regulatory product standard’s requirements.</span>
          </Typography>
        </Container>
      ...
      <Grid item xs={12}>
        ...
        {Phase2 ? <>
          <Container maxWidth='lg'>
            ...
            <Grid container  >
            <  TextField  value={  Description__ExistingProducts   } onChange={(e) => setDescription__ExistingProducts  (e.target.value)}  
          ...
          <Container maxWidth="lg">
                ...
                <Table style={{ width: 1100 }}>
                  ...
                  <TableBody>
                      ...
                      <TableRow  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    EMC__Existing_Products       } onChange={(e) => setEMC__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  EMC__Existing_Products1    } onChange={(e) => setEMC__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    SAFETY__Existing_Products       } onChange={(e) => setSAFETY__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  SAFETY__Existing_Products1    } onChange={(e) => setSAFETY__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
                      ...
                      <TableRow  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    LASER_SAFETY__Existing_Products       } onChange={(e) => setLASER_SAFETY__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  LASER_SAFETY__Existing_Products1    } onChange={(e) => setLASER_SAFETY__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
                      ...
                      <TableRow  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    MEDICAL_SAFETY__Existing_Products       } onChange={(e) => setMEDICAL_SAFETY__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  MEDICAL_SAFETY__Existing_Products1    } onChange={(e) => setMEDICAL_SAFETY__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
                      ...
                      <TableRow  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    IP_TESTING__Existing_Products       } onChange={(e) => setIP_TESTING__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  IP_TESTING__Existing_Products1    } onChange={(e) => setIP_TESTING__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    EMC_3m_CHAMBER_TIME__Existing_Products       } onChange={(e) => setEMC_3m_CHAMBER_TIME__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  EMC_3m_CHAMBER_TIME__Existing_Products1    } onChange={(e) => setEMC_3m_CHAMBER_TIME__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
                      ...
                      <TableRow  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    EMC_10m_CHAMBER_TIME__Existing_Products       } onChange={(e) => setEMC_10m_CHAMBER_TIME__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  EMC_10m_CHAMBER_TIME__Existing_Products1    } onChange={(e) => setEMC_10m_CHAMBER_TIME__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
                      ...
                      <TableRow  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="left" component="th" scope="row" ><span style={{ color: "black" }}>No</span> <Switch size="small" /><span style={{ color: "black" }} checked={    ENVIRONMENTAL_CHAMBER_TIME__Existing_Products       } onChange={(e) => setENVIRONMENTAL_CHAMBER_TIME__Existing_Products         (e.target.checked)}  size="small" /><span style={{ color: "black" }}>Yes</span></TableCell>
                        <TableCell align="left"   >                <TextField name="creator" className={classes.textfiledtable} variant="filled" style={{ backgroundColor: "transparent" }}  value={  ENVIRONMENTAL_CHAMBER_TIME__Existing_Products1    } onChange={(e) => setENVIRONMENTAL_CHAMBER_TIME__Existing_Products1      (e.target.value)}   size="small" label=" Name of components  affected" align="center" /><Typography className={classes.hrs} variant="caption"> </Typography> </TableCell>
                        <TableCell align="left"    >
                       </TableCell>
                      </TableRow>
            ...
            <Grid container >
              <TextField
                className={classes.textarea}
           value={  Pleaseselectintendedmarketcountries   } onChange={(e) => setPleaseselectintendedmarketcountries  (e.target.value)}  
                variant="filled" style={{ backgroundColor: "transparent" }}
                id="outlined-multiline-flexible"
                label=""
            ...
            <Box  >
              ...
              <Typography style={{}} variant='body1' className={classes.MainHeading3a}>  Please upload user guide and other supporting documents to understand the changes (comparison between current & future state) to the existing design.</Typography>
                  ...
                  {inputFields2.map(inputField => (
                    <>   <div key={inputField.id}>
                      ...
                      <Paper className={classes.paper}>
                        ...
                        <Button variant="contained" startIcon={<CloudUploadIcon />} component="label" className={classes.bottomdragndrop}   >
                          ...
                          <FileBase
                            ...
                            defaultName="Custom Choose File Name"
                            onDone={({ base64 }) =>
                              handleChangeInput2(inputField.id, { target: { name: "lastName", value: base64 } })
                            }
                          />
                        </Button>
                        {/* <Avatar
                      ...
                      > <DeleteOutlineOutlinedIcon size="small" />
                        ...
                        <IconButton
                          disabled={inputFields.length === 1} onClick={() => handleRemoveFields2(inputField.id)}
                          aria-label="download"
                          size="small"
                          className={classes.addmorebottommultiple}
                        >
        ...
        {Phase3 ? <>
          <Container maxWidth="sm">
            <Typography variant="h6" gutterBottom className={classes.MainHeading2}>
            ...
            <Paper className={classes.Paper}>
              <form className={classes.form}>
                ...
                <TextField
                  ...
                  className={classes.textfieldlast}
                />
                <Button className={classes.buttonFind} variant="contained" color="primary" size="medium" type="submit"> Search </Button>
              </form>
            </Paper>
          </Container>
...
export default Evaluated_product
